...
class TransferDomainRequest
{
     ...
     */
    public function __construct($domainName, $eppCode, $duration, $customerUsername, $customerPassword, $fullName, $companyName, $email, $address1, $address2, $address3, $city, $province, $countryCode, $postalCode, $phoneNumber, $mobilePhoneNumber)
    {
